...
// | LotusAdmin 
// +----------------------------------------------------------------------
// | Copyright (c) 2013-2017 https://www.lotusadmin.top/ All rights reserved.
// +----------------------------------------------------------------------
...
class Index extends Controller
{
    ...
    {
        if (lotus_is_installed()) {
            $this->error('网站已经安装', url('/'));
        }
    }
    ...
    //        }
        ...
        $folders    = [
            realpath(LOTUS_ROOT . 'data') ,
            realpath(LOTUS_ROOT.'runtime'),
            realpath(LOTUS_ROOT.'public\upload'),
        ];
    ...
    public function step4()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $sql = lotus_split_sql(APP_PATH . 'install/data/lotus.sql', $dbConfig['prefix'], $dbConfig['charset']);
...
//            $siteInfo    = $this->request->param('siteinfo');
            ...
            session('install.site_info', [
                ...
                'site_seo_keywords'    => $siteName,
                'site_seo_description' => $siteName
            ]);
    ...
    public function setDbConfig()
    {
        ...
        $dbConfig['authcode'] = lotus_random_string(18);
    ...
    public function setSite()
    {
        ...
        try {
            // lotus_set_option('site_info', $siteInfo);
    ...
    public function step5()
    {
        if (session("install.step") == 4) {
            @touch(LOTUS_ROOT . 'data/install.lock');
