...
require_once __DIR__."/../request/AlipayTradePayRequest.php";
require_once __DIR__."/../request/AlipayTradeQueryRequest.php";
require_once __DIR__."/../request/AlipayTradeCancelRequest.php";
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( __DIR__."/../log/alipaylog.log", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
