<?php /*a:2:{s:69:"D:\wamp\www\freejxc\application\admin\view\stocks\stockstakeList.html";i:1580785095;s:57:"D:\wamp\www\freejxc\application\admin\view\pub\modal.html";i:1580923563;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table id="lotus-table"  lay-data="{page:true,limits:[10,20,100],loading:true,toolbar:'#toolbarDemo',url:'stockstakeListJson',hash:''}"  class="layui-table layui-hide" lay-filter="lotus-table">
                        <thead>
                        <tr>
                    ...
                    <script type="text/html" id="actionTpl">
                        ...
                        {{#  if(d.or_finish==0){  }}
                        <button onclick="xadmin.open('编辑盘点订单','editStocksTake.html?or_id={{d.or_id}}',900,600)" class="layui-btn  layui-btn-xs">编辑</button>
                        {{#  } }}
                    ...
                    <script type="text/html" id="verifyTpl">
                      ...
                      <span class="layui-badge layui-bg-green">已审</span>
                        {{# }else{ }}
                        <button class="layui-btn layui-btn-sm layui-badge" onclick="xadmin.open('编辑盘点订单','editStocksTake.html?or_id={{d.or_id}}',900,600)" title="点击审核时会处理库存">未审</button>
                      {{# } }}
                    </script>
                </div>
            </div>
