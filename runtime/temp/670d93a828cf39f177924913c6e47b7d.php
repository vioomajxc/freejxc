<?php /*a:2:{s:65:"D:\wamp\www\freejxc\application\admin\view\stocks\stocksTake.html";i:1580770561;s:57:"D:\wamp\www\freejxc\application\admin\view\pub\modal.html";i:1580923563;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <form class="layui-form layui-col-space8" method="post" id="lotus-sigle-edit-form" action="stocksTake" lay-filter="lotus-form-filter">
                        <div class="layui-row">
                        ...
                        <div class="layui-input-inline">
                            <select lay-filter="aihao" name="or_house">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input class="layui-input" autocomplete="off" name="barcode" id="barcode">
                        </div>
                    </div>
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择要添加的商品','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=stocks_take',800,600)"><i class="layui-icon"></i>选择商品</button>
...
$(function(){
    ...
    $('#barcode').focus();
        $('#barcode').bind('keypress',function(event){
            ...
            $.ajax({
            url: "<?php echo url('/admin/pub/barcodeScan?ordertype=stocks_take'); ?>",
            type: 'post',
            dataType: 'json',
