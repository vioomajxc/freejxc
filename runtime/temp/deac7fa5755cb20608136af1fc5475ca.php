<?php /*a:3:{s:60:"D:\wamp\www\freejxc\application\admin\view\report\sales.html";i:1581227775;s:61:"D:\wamp\www\freejxc\application\admin\view\pub\container.html";i:1580970373;s:62:"D:\wamp\www\freejxc\application\admin\view\pub\buildchart.html";i:1581074324;}*/ ?>
<!doctype html>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">销售金额统计</div>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">销售退货统计</div>
                <div class="layui-card-body layui-row">
                    <div class="layui-col-md12">
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">店铺销售饼状图</div>
                <div class="layui-card-body layui-row">
                    <div class="layui-col-md12">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">会员购买排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo htmlentities($limit); ?></span></div>
                    <div class="layui-card-body layui-row">
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">销售产品排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo htmlentities($limit); ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
            ...
            methods:{
                ...
                getBusinesChart:function(){
                    ...
                    layList.baseGet(layList.Url({a:'getBusinesChart',q:{data:this.data,type:'sales'}}),function (rem) {
                        ...
                        var visit=that.setoption(rem.data.visit_data,rem.data.visit_xdata,null,'销售退货金额曲线图','line',rem.data.visit_zoom);
                        that.myChart.user.setOption(visit);
                        var shop=that.setoption(rem.data.shop_data,rem.data.shop_xdata,null,'店铺销售饼状图','pic','');
                        that.myChart.shop.setOption(shop);
                    });
                },
                setoption:function(seriesdata,xdata,legend,title,type,Zoom){
                    var _type=type || 'line';
                    var _title=title || '销售金额趋势图';
                    switch (_type){
                        case 'line':
                            this.option={
