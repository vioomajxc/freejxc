<?php /*a:2:{s:66:"D:\wamp\www\freejxc\application\admin\view\storage\addStorage.html";i:1580674005;s:57:"D:\wamp\www\freejxc\application\admin\view\pub\modal.html";i:1580923563;}*/ ?>
<!doctype html>
...
this.elem.next().find('.layui-table td[data-field=sum] .layui-table-cell:last').text(sumTotal.toFixed(2))
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <div class = "layui-btn-container" >
                            <button class="layui-btn layui-btn-sm" onclick="xadmin.open('选择要添加的商品','/admin/pub/selectGoods.html?or_id=<?php echo htmlentities($or_id); ?>&ordertype=procure',800,600)"><i class="layui-icon"></i>选择商品</button>
