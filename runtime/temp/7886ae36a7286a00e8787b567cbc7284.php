<?php /*a:2:{s:65:"D:\wamp\www\freejxc\application\admin\view\goods\addCategory.html";i:1575255702;s:57:"D:\wamp\www\freejxc\application\admin\view\pub\modal.html";i:1580923563;}*/ ?>
<!doctype html>
...
<div class="layui-fluid lotus-form">
    <div class="layui-row">
        <form class="layui-form layui-form-pane" id="lotus-add-form" action="addCategory" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text"  name="category_name" lay-verify="required" autocomplete="off"  class="layui-input">
                </div>
            </div>
