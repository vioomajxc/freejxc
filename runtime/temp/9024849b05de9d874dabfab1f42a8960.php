<?php /*a:2:{s:67:"D:\wamp\www\freejxc\application\admin\view\stocks\decreaseList.html";i:1580916327;s:57:"D:\wamp\www\freejxc\application\admin\view\pub\modal.html";i:1580923563;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space8" id="ajaxForm" method="get" action="decreaseListJson">
                ...
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table id="lotus-table"  lay-data="{page:true,limits:[10,20,100],loading:true,toolbar:'#toolbarDemo',url:'decreaseListJson',hash:''}"  class="layui-table layui-hide" lay-filter="lotus-table">
                        <thead>
                        <tr>
                    ...
                    <script type="text/html" id="toolbarDemo">
                        <button class="layui-btn layui-btn-sm layui-btn-green" onclick="xadmin.open('添加损耗单','addDecrease.html',900,620)"><i class="layui-icon layui-icon-rmb"></i>新建报损</button>
                        <button class="layui-btn layui-btn-sm layui-btn-normal" lay-event="getCheckPay"><i class="layui-icon layui-icon-rmb"></i>损耗出账</button>
                    </script>
                    ...
                    <script type="text/html" id="actionTpl">
                        <button onclick="xadmin.open('查看报损订单','seeOrder.html?or_id={{d.or_id}}&ordertype=<?php echo htmlentities($ordertype); ?>',900,600)" class="layui-btn  layui-btn-xs layui-btn-normal">查看</button>
                        {{#  if(d.or_finish==0){  }}
                        <button onclick="xadmin.open('编辑报损订单','editDecrease.html?or_id={{d.or_id}}',900,600)" class="layui-btn  layui-btn-xs">编辑</button>
                        {{#  } }}
                    ...
                    <script type="text/html" id="finishTpl">
                      ...
                      <span class="layui-badge layui-bg-green">已完成</span>
                        {{# }else{ }}
                        <button class="layui-badge layui-btn layui-btn-sm" onclick="lotus.verifyOrder('{{d.id}}','/admin/pub/finishOrder?ordertype=pay')">未完成</button>
                      {{# } }}
                    </script>
